...
val initialize:List[Card]= List(Card("Die erste Postanweisung",817),Card("Sarah und Lukas erstellen eine virtuelle version von Anno Domini",2020),
  ...
  Card("Die ersten Inline-Skates kommen au den Markt: Rollschuhe mit fünf hintereinanderliegenden Rollen und Bremsklötzen",1823),
  Card("Die 'New York World' druckt das erste Kreuzworträtsel ab.",1913),
  Card("Der Norweger Erik Rothein erfindet die Spraydose.",1711),
  Card("Der Norweger Johann Vaaler lässt die Büroklammer patentieren", 1900))
